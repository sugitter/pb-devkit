...
> 无需安装 PowerBuilder IDE，在命令行即可完成 PBL 源码导出、分析、重构、导入、编译全流程。
...
- PowerBuilder / PB / PBL 相关的开发、维护、迁移、分析
- 查看或导出 PB 源码（.sr* 文件）
- 分析 PB 代码质量、依赖关系、复杂度
- 重构或优化 PB 旧系统代码
- PB 项目结构梳理、文档生成
...
# Step 4: 导出所有源码
python pb.py export F:\path\to\project ./exported
...
```bash
# 1. 导出源码
python pb.py export module.pbl ./work
